// @copypaste https://github.com/Tinkoff/investAPI/blob/7885f216627577d08f13b1ac52c78fcdaaf96130/src/docs/errors/api_errors.json
type Errors = {
...
export const errorStatus: Errors = {
  ...
  "30022": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *state* является обязательным. </br> Укажите корректный параметр *state*.</br>Список доступных значений: [*direction*](https://tinkoff.github.io/investAPI/operations/#operationstate)."
  },
  "30023": {
    "message": "invalid parameter: 'state'",
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *state* имеет некорректное значение. </br> Укажите корректный параметр *state*.</br>Список доступных значений: [*direction*](https://tinkoff.github.io/investAPI/operations/#operationstate)."
  },
  "30025": {
  ...
  "30028": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *order_id* имеет некорректное значение.</br>Укажите корректный параметр *order_id*."
  },
  "30029": {
  ...
  "30030": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *idempotency_key* имеет некорректное значение.</br>Укажите корректный параметр *idempotency_key*."
  },
  "30031": {
  ...
  "30070": {
    ...
    "type": "INVALID_ARGUMENT",
    "description": "Входной параметр *from* имеет некорректное значение.</br>Укажите корректный параметр."
  },
  "30077": {
  ...
  "40002": {
    ...
    "description": "Недостаточно прав для совершения операции. </br>Токен доступа имеет уровень прав read-only, либо у токена нет доступа к указанному счету.</br>Подробнее: [Виды токенов](https://tinkoff.github.io/investAPI/index#_2)"
  },
  "40003": {
    "message": "authentication token is missing or invalid",
    "type": "UNAUTHENTICATED",
    "description": "Токен доступа не найден или не активен. </br>Вы можете выпустить новый токен по ссылке [Настройки](https://www.tinkoff.ru/invest/settings/)"
  },
  "40004": {
